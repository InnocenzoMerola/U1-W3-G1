...
function concTrasforms(string1, string2) {
  ...
  console.log("Es. 1: ", resultUpperCase);
}
concTrasforms("epicode", "developer");
...
const sumnumbers = [2, 6, 9, 15, 22];
let sum = 0;

const sumFunct = sumnumbers.forEach((num) => (sum += num));
